...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		frame.setTitle("im a fat duck");
		// 3. Create a JPanel variable to hold the header using the createHeader method
		JPanel header = createHeader("Engineer");
		...
		firstButton = createButton("55896758");
		...
		// method
		secondButton = createButton("300000");
...
if (arg0.getSource()==(firstButton)) {
	askQuestion("How do you make a fat duck", "oil and duck",327589);
} 
else if(arg0.getSource()==(secondButton)){
	askQuestion("Why is the letter T like an island", "bc it's in the middle of water", 4545454);
}
...
secondButton.setText("");
 ...
 String s1 = JOptionPane.showInputDialog(null, question);
